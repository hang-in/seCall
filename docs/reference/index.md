...
2. [handoff_2026-06-25.md](handoff_2026-06-25.md) — 최신 세션 핸드오프 (현재 작업 맥락)
...
- [handoff_2026-06-25.md](handoff_2026-06-25.md) — 최신 세션 핸드오프 (v0.6.0~0.6.3 릴리스 + 외부 PR + CLI 변동 점검; 다음=PR #108) · 상태: draft
